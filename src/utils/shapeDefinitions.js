export default {
    ...
    shapeItems: [
        ...
        { position: "top-80 right-24", size: "md", color: "teal", shape: "roundedMd", opacity: "opacity-75", effect: "rotateReverse", isShow: "invisible sm:visible" },
        { position: "bottom-96 left-5", size: "md", color: "pink", shape: "circle", opacity: "opacity-50", effect: "bounce" },
        { position: "bottom-10 left-20", size: "xxl", color: "red", shape: "square", opacity: "opacity-50", effect: "rotateSmall", isShow: "invisible sm:visible" },
